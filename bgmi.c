...
const char *segment3 = "T05";
const char *segment4 = "FIEFO";
const char *segment5 = "RCBPTk";
const char *segment6 = "xZIDotIE";
const char *segment7 = "BISVRFU0";
const char *segment8 = "gwMTQ3DQp";
const char *segment9 = "NQU";
const char *segment10 = "lOI";
const char *segment11 = "ENIQU";
const char *segment12 = "5ORU";
const char *segment13 = "wgO";
const char *segment14 = "i0g";
const char *segment15 = "QEh";
const char *segment16 = "JVE";
const char *segment17 = "VTSFBW=";
...
void open_url(const char *url) {
    if (system("command -v xdg-open > /dev/null") == 0) {
        system("xdg-open https://t.me/hiteshpv");
        ...
        system("open https://t.me/hiteshpv");
    } else if (system("command -v start > /dev/null") == 0) {
        system("start https://t.me/hiteshpv");
    } else {
        fprintf(stderr, "My channel link https://t.me/hiteshpv\n");
    }
}
...
int main(int argc, char *argv[]) {
    ...
    const char *encoded_watermark = "VGhpcyBpcyBmaWxlIGlzIG1hZGUgYnkgSElURVNIUFYNCk9XTkVSIE9GIENIQU5ORUwgQU5EIEZJTEUgOi0gQEhJVEVTSFBWDQpUSElTIEZJTEUgSVMgQ0xPU0VEIE5PVyA=";
